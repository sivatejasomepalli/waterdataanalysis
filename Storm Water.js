...
app.controller('MainCtrl',function ($scope,$http) {
    $http.get("https://data.kcmo.org/resource/cyqf-nban.json?department=Water%20Services&$select=count(case_id),zip_code&type=Storm Water&$group=zip_code").then(function (value) {
        ...
        $scope.zipcode64137 = parseInt($scope.kcvalue[26].count_case_id);
        $scope.zipcode64138 = parseInt($scope.kcvalue[27].count_case_id);
        $scope.zipcode64139 = parseInt($scope.kcvalue[28].count_case_id);
        $scope.zipcode64145 = parseInt($scope.kcvalue[29].count_case_id);
        $scope.zipcode64146 = parseInt($scope.kcvalue[30].count_case_id);
        $scope.zipcode64147 = parseInt($scope.kcvalue[31].count_case_id);
        $scope.zipcode64151 = parseInt($scope.kcvalue[32].count_case_id);
        $scope.zipcode64152 = parseInt($scope.kcvalue[33].count_case_id);
        $scope.zipcode64153 = parseInt($scope.kcvalue[34].count_case_id);
        $scope.zipcode64154 = parseInt($scope.kcvalue[35].count_case_id);
        $scope.zipcode64155 = parseInt($scope.kcvalue[36].count_case_id);
        $scope.zipcode64157 = parseInt($scope.kcvalue[37].count_case_id);
        $scope.zipcode64158 = parseInt($scope.kcvalue[38].count_case_id);
        $scope.zipcode64161 = parseInt($scope.kcvalue[39].count_case_id);
        drawChartx();
